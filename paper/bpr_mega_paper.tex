...
$p = 104{,}761$ and coordination number $z = 6$ as structural inputs.
...
\begin{itemize}
\item $p = 104{,}761$ is the nearest valid prime ($p\equiv 1\pmod{4}$) to $p_\text{exact}=104{,}749$, derived from the boundary formula
...
sectors of the $p = 104{,}761$ substrate.  The topological constraint is
\begin{equation}
...
winding sectors of $p = 104{,}761$.  The anomaly cancellation condition
...
Master prediction table.  All values derived from $(p, z) = (104{,}761, 6)$
...
$p = 104{,}761$ is a selection from primes rather than a purely deductive
...
\quad (a = 3.54\times10^{-4}~\text{m},\; p = 104{,}761).
\end{equation}
