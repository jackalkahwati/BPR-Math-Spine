...
104761$ and a winding number $W \in \mathbb{Z}$.  We derive three
...
prime lattice of size $p$.  The prime $p = 104761$ is the unique topological
...
substrate parameters $(J,\, p,\, N)$; the value $p = 104761$ was fixed by
...
\begin{itemize}
  ...
  \item A proof that GUE statistics do not arise from the Katz--Sarnak chain
    at the $p = 104761$ substrate (falsifies the mathematical foundation).
\end{itemize}
